...
$pdf->Cell(40, 10, 'RS ' . number_format($before_tax,2), 1);
$pdf->Ln();

$pdf->Cell(150, 10, 'Tax (' . ($tax_rate * 100) . '%)', 1);
$pdf->Cell(40, 10, 'RS ' . number_format($tax_amount,2), 1);
$pdf->Ln();

$pdf->Cell(150, 10, 'Grand Total', 1);
$pdf->Cell(40, 10, 'RS ' . number_format($after_tax,2), 1);
$pdf->Ln();
