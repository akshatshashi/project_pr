...
<body>
      ...
      <div class="nav-bar">
        <div class="brand">
          <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;">SNU FOODs</h1><span class="sr-only"></span>
          </a>
        </div>
        <div class="nav-list">
          <div class="hamburger">
  ...
  <section id="hero" style="position: relative;">
    <video autoplay loop muted playsinline poster="your-poster-image.jpg" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;">
      <source src="../image/Restaurant_Video_Trimmed.mp4" type="video/mp4">
    ...
    <div class="hero container" style="position: relative; z-index: 1;">
      <div>
        <h1><strong>
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> SNU </h1><span></span>
          </strong></h1>
        <h1><strong style="color:white;">FOODs<span></span></strong></h1>
  ...
  <section id="projects">
    <div class="projects container">
      <div class="projects-header">
        <h1 class="section-title"><a href="https://menu-foods.vercel.app" target="_blank">Me<span>n</span>u</a></h1>
  ...
  <div class=" about container">
        <div class="col-right">
          ...
          <h2>SNU FOODs:</h2>
          <p>Welcome to SNU FOODs, your ultimate destination for delicious and diverse dining experiences within the vibrant campus of Shiv Nadar University. At SNU FOODs, we pride ourselves on offering an extensive array of culinary delights, catering to the diverse tastes and preferences of our esteemed students, faculty, and visitors.
          </p>
          <p>With a wide range of vendors conveniently located throughout the campus, SNU FOODs ensures that every craving is satisfied, from savory rolls to indulgent waffles. Whether you're in the mood for a quick bite between classes or a leisurely meal with friends, our vendors are ready to serve up mouthwatering delights that will tantalize your taste buds.
          </p>
          <p>For those seeking healthier options, look no further than Greenox, our dedicated outlet for nutritious and wholesome meals. From fresh salads to hearty sandwiches, Greenox is committed to providing nourishing options that fuel both body and mind, ensuring you stay energized throughout your busy day on campus.
          </p>
          <p>Craving something with a bit more flair? Explore the diverse world of dosas at our various vendor outlets, where you'll find an enticing selection of this South Indian specialty prepared in a multitude of delicious ways. From classic masala dosas to innovative twists on traditional recipes, there's something to satisfy every dosa enthusiast at SNU FOODs.
          </p>
    ...
    <div class="contact-items">
      ...
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          ...
          <h1>Address</h1>
          <h2>NH 91, Tehsil Dadri, Greater Noida, Uttar Pradesh, 201314</h2>
        </div>
      </div>
    </div>
    </div>
  ...
  <section id="footer">
    <div class="footer container">
      ...
      <p>By Akshat Shashi, Preksha Khera and Kritika Prasad</p>
  ...
  <style type="text/css">
    ...
    .item-name {
      ...
      /* Ensure items are displayed on separate lines */
      width: 100%;
    ...
    .item-price {
      display: inline-block;
      /* Ensure prices are displayed on separate lines */
      width: 30%;
      /* Adjust the width as needed */
      float: right;
    }
    ...
    .profile-link {
      ...
      /* Smaller border style and color */
      padding: 3px 8px;
      /* Smaller padding inside the border */
      border-radius: 3px;
      ...
      /* Text color */
      margin-left: auto;
      /* Automatically push the link to the right */
      margin-right: 10px;
    ...
    #contact .col-right h2 {
      ...
      color: white;
      /* Text color for the right column */
    }
    ...
    .contact-item-bg {
      ...
      border-radius: 5px;
      margin-bottom: 20px;
      /* Add margin between contact items */
    }

    .contact-item-bg h1,
    .contact-item-bg h2 {
      color: white;
      /* Text color for the contact items */
    }
    ...
    .contact-item-bg .icon img {
      width: 80px;
      /* Adjust the width of the icon images */
      height: 80px;
      /* Adjust the height of the icon images */
    }
    ...
    .dropdown-content a:hover {
      background-color: #ddd;
      color: black;
      /* Set the text color to black on hover if needed */
    }
    ...
    .tooltip {
      ...
      font-size: 0.9em;
      margin-top: 50px;
      /* Add margin to move the tooltip below the element */
      left: 0;
      /* Set left to 0 to align with the element */
      width: 100%;
      /* Make the tooltip span the width of the element */
      text-align: center;
